...
impl c_game_engine_oddball_variant {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) {
        ...
        bitstream.write_integer(self.m_score_to_win as u32, 11);
        bitstream.write_integer(self.m_carrying_points as u32, 5);
        bitstream.write_integer(self.m_kill_points as u32, 5);
        bitstream.write_integer(self.m_ball_kill_points as u32, 5);
        bitstream.write_integer(self.m_carrier_kill_points as u32, 5);
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) {
        ...
        self.m_score_to_win = bitstream.read_u16(11);
        self.m_carrying_points = bitstream.read_u16(5);
        self.m_kill_points = bitstream.read_u8(5);
        self.m_ball_kill_points = bitstream.read_u8(5);
        self.m_carrier_kill_points = bitstream.read_u8(5);
