...
impl c_game_engine_vip_variant {
    pub fn encode(&self, bitstream: &mut c_bitstream_writer) {
        ...
        bitstream.write_integer(self.m_takedown_points as u32, 5);
        bitstream.write_integer(self.m_kill_as_vip_points as u32, 5);
        bitstream.write_integer(self.m_vip_death_points as u32, 5);
        bitstream.write_integer(self.m_destination_arrival_points as u32, 5);
        bitstream.write_integer(self.m_suicide_points as u32, 5);
        bitstream.write_integer(self.m_vip_suicide_points as u32, 5);
    ...
    pub fn decode(&mut self, bitstream: &mut c_bitstream_reader) {
        ...
        self.m_takedown_points = bitstream.read_u8(5);
        self.m_kill_as_vip_points = bitstream.read_u8(5);
        self.m_vip_death_points = bitstream.read_u8(5);
        self.m_destination_arrival_points = bitstream.read_u8(5);
        self.m_suicide_points = bitstream.read_u8(5);
        self.m_vip_suicide_points = bitstream.read_u8(5);
